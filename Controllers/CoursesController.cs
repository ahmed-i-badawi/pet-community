...
namespace PetCommunity.Controllers
{
 ...
 private readonly UserManager<User> UserManager = null;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                 DocName = UserManager.Users.Where(e => e.Email == User.Identity.Name).FirstOrDefault().FirstName;
            }
            var applicationDbContext = _context.Courses.Include(c => c.Doctor).ThenInclude(a => a.User.FullName == DocName);
